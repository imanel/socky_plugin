...
** none
* bugfixes
** ie7 should now properly reconnect after connection is broken

h2. 0.3.0 / 2010-10-24

* new features:
** removal of Rails dependency - from now you can use Socky plugin in any Ruby application
* bugfixes:
** use 'json' gem if available(faster than Rails implementation)
